...
const buttons = [{ name: "Log Out", url: "#" }];
    ...
    <header>
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <a href={iconUrl.link} className="flex items-center">
            <img src={iconUrl.icon} className="mr-3 h-6 sm:h-9" alt={iconUrl.alt} />
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Clubs</span>
          </a>
